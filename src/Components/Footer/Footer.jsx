      ...
      <div className="container mx-auto px-4">
        ...
        <div className="md:flex justify-between mb-10">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900 mb-4">+8801778821588</p>
            <p className="text-sm font-semibold">hanif.mia2233@gmail.com</p>
            <p className="text-sm">Gulshan Dhaka Bangladesh</p>
          </div>
        </div>
        ...
        <div className="mt-8 flex justify-between items-center text-sm text-gray-500">
          ...
          <div className="flex space-x-4 cursor-pointer">
            <img src="https://www.paypalobjects.com/marketing/web/logos/paypal-mark-color.svg" alt="PayPal" className="h-6" />
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d6/Visa_2021.svg/220px-Visa_2021.svg.png" alt="Visa" className="h-6" />
            <img src="https://vertexbazaar.com/wp-content/uploads/2024/01/mastercard-banner-600x157.webp" alt="Mastercard" className="h-6" />
